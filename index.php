...
<body>
  ...
  <div class="input-fields">
    ...
    if ($user->isLoggedIn()) {
      ?>
      <div id="login-field">
        <div class="title-text mb-25"> HELLO: <?php echo escape($user->data()->name); ?><i class="mb-icon mb-25"></i> </div>
        <div class="mb-15"><a class="link-text" href="#">Action1</a></div>
        <div class="mb-15"><a class="link-text" href="#">Action2</a></div>
        <div class="mb-25"><a class="link-text" href="#">Action3</a></div>
        <a href="includes/logout.php"><button type="submit" class="login-btn">LOGOUT</button></a>
      </div>
    <?php
    }
    ?>
